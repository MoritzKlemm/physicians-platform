...
import {GET_PRIVACY} from '../graphql/queries'
...
const PrivacyPage: React.FC<PrivacyType> = ({privacyContent}) => {
   return (
         ...
         <ul>
            ...
            <li>
               <p>
                  ...
                  Businesn name (Lehrstuhl von der Uni?), Anschrift des Lehrstuhls.
               </p>
            </li>
            <li>
               <p>
            ...
            <li>
               <p>
                  <strong>Website</strong> refers to ICFA Board, accessible from
                  <a href="https://icfa-bd.org" target="_blank">
                     {' '}
                     icfa-bd.org
                  </a>
               </p>
...
export const getStaticProps: GetStaticProps = async () => {
   ...
   const {footer} = await request(endpointGraphql, GET_PRIVACY)
   return {
      props: {
         privacyContent: footer.privacy
      },
      revalidate: 1
   }
}
